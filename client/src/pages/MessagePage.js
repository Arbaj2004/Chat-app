...
const MessagePage = () => {
    ...
    return (
        <div className='grid lg:grid-cols-[300px,1fr] h-screen max-h-screen'>
            ...
            {/* show all messages */}
            <section className={`h-[calc(100vh-128px)] overflow-x-hidden ${meassage?.imageUrl || meassage?.videoUrl || loading ? "overflow-y-hidden" : "overflow-y-auto"}  scrollbar relative bg-slate-200 bg-opacity-50`}>
